                                    ...
                                    <form class="kt-form kt-form--label-right" method="POST"
                                        ...
                                        <div class="kt-portlet__body">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control" type="number" value="42" id="numero_id"
                                                        name="numero">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-12">
                                                     ...
                                                     <textarea class="form-control" rows="12" id="descripcion_id" name="descripcion"></textarea>
...
<script>
    ...
    function datosPersonales(){
        divDatosPersonales=document.getElementById('datosPersonales');
        nombre= document.getElementById('nombre_id').value;
        direccion= document.getElementById('direccion_id').value;
        correo= document.getElementById('correo_id').value;
        numeroTelefono= document.getElementById('numeroTelefono_id').value;
    ...
    function datosLugarHechos(){
        divDatosLugarHechos=document.getElementById('lugarHechos_id');
        calle= document.getElementById('calle_id').value;
        numero= document.getElementById('numero_id').value;
        ...
        divDatosLugarHechos.innerHTML=
       "Calle: "+ nombre+"<br>"+
        "Numero: "+direccion+"<br>"+
        "Municipio: " +nombreMunicipio;
    }

    function datosDescripcion(){
        divDescripcion=document.getElementById('div_descripcion_id');
        descripcion= document.getElementById('descripcion_id').value;
